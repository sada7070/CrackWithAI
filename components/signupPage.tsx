    ...
    return <div className="h-screen">
        ...
        <div className="border-3 border-slate-400 shadow-xl rounded-2xl mt-20 md:m-20 p-6 px-10 md:px-15 dark:shadow-slate-800 shadow-slate-600">
            <div>
                ...
                <h3 className="pt-4 font-medium">First Name</h3>
                <Input onChange={(e) => {
                    setFirstName(e.target.value);
                }} placeholder="Enter your FirstName" />

                <h3 className="pt-4 font-medium">Last Name</h3>
                <Input onChange={(e) => {
                    setLastName(e.target.value);
                }} placeholder="Enter your LastName" />

                <h3 className="pt-4 font-medium">Password</h3>
                <Input onChange={(e) => {
                ...
                <p className="text-sm font-medium pt-2"> Already have an account?
                    <Link href='/signin'>
                        <Button className="underline pl-2 cursor-pointer font-bold" variant='link' size='sm'>Signin</Button>
                    </Link>
                </p>
            </div>
            ...
            <div className="pt-2">
                ...
                }} className="cursor-pointer font-medium w-full">Signup</Button>
            </div>
        </div>  
    </div>  
    </div>
